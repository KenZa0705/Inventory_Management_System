...
(
    ...
    CONSTRAINT payment_details_pkey PRIMARY KEY (order_id)
);
...
(
    ...
    CONSTRAINT shipping_details_pkey PRIMARY KEY (order_id)
);
...
ALTER TABLE IF EXISTS public.payment_details
    ADD CONSTRAINT payment_details_order_id_fkey FOREIGN KEY (order_id)
    REFERENCES public.orders (order_id) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;
CREATE INDEX IF NOT EXISTS payment_details_pkey
    ON public.payment_details(order_id);


ALTER TABLE IF EXISTS public.shipping_details
    ADD CONSTRAINT shipping_details_order_id_fkey FOREIGN KEY (order_id)
    REFERENCES public.orders (order_id) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;
CREATE INDEX IF NOT EXISTS shipping_details_pkey
    ON public.shipping_details(order_id);
